...
import '../widgets/deal_card_my_add.dart';
  ...
  Widget build(BuildContext context) {
    return (firsttime.isEmpty)
        ...
        : Scaffold(
            ...
            body: FutureBuilder(
                future: api.getaddsbyuserid(firsttime),
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return MyAddDealCard(
                                  ...
                                  // isLive: snapshot.data![index].isLive!,
                                  imageurl:
